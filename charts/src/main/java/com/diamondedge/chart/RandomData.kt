...
class RandomData : DefaultData {
    ...
    constructor() : super(SIMPLE_SERIES)

    constructor(seriesType: Int) : super(seriesType)

    constructor(seriesType: Int, seriesCount: Int) : super(seriesType) {
        seriesCount_set = seriesCount
    }

    constructor(seriesType: Int, minval: Double, maxval: Double) : super(seriesType) {
