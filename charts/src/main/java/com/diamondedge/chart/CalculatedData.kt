...
class CalculatedData(functionType: Int = 0, periodStyle: Int = ALL_POINTS, period: Double = 0.0, private val ddata: ChartData) :
    DefaultData(XY_SERIES) {
    /** Returns the series used.
     */
    /** Sets the series used when period is greater than 0
    ...
    /** Returns the function that will calculate each data point.
     */
    /** Sets the function that will calculate each data point.
     */
    var functionType = 0
    /** Returns the alignment of the calculated data point with respect to
     * the set of data (period) used to calculate it.
     */
    /** Sets the alignment of the calculated data point with respect to
     * the set of data (period) used to calculate it.
     */
    var alignment = CENTER
    /** Returns the period style.
     */
    /** Sets the period style.
     */
